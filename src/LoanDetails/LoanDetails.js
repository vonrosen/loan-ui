...
import { ResponsiveContainer, Label, BarChart, Bar, XAxis, YAxis } from 'recharts';
    ...
    render() {
        ...
        return (
            <StyledDiv term={term}>
                ...
                <ResponsiveContainer minHeight={350} minWidth={800}>
                    <BarChart margin={{ top: 0, right: 30, bottom: 0, left: 30 }} data={formattedData}>
                        <XAxis dataKey="Rate" tick={{ fontSize: 20 }} />
                        <YAxis padding={{ top: 40 }} dataKey="LoanAmount" tick={{ fontSize: 12 }} type="number"
                            domain={[0, maxLoanValue]} tickFormatter={
